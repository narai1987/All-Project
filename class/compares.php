<?php
	...
	class compareClass extends DbAccess {
		...
		function show(){
			...
			$query = "SELECT ts.trip_title,sch.trip_price,t.image,b.boat_length,b.boat_engine,b.boat_enginepower,b.boat_technical,b.boat_beam,b.men_capacity,b.fuel_capacity,b.boat_comunication_and_navigation"
			. " ,b.hull_type,b.hull_material,b.boat_width,bs.boat_name,b.id AS boat_id,b.boat_range,b.fresh_water_capacity,b.gray_water_capacity,b.black_water_capacity,b.boat_safety,b.boat_facilities"
