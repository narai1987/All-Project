...
<td><select class="person" name="adult" id="adult" onChange="divPerson(this.value,0)">
<?php for($i=1;$i<=15;$i++){ ?>
...
<h3><a href="#">Member 1</a></h3>
	<div>
        <p>
        <input type="text" class="lang_box left" id="person1" placeholder="Name" name="person[]" value="<?php echo $person['p_name'];?>" />
        ...
        <p style="clear:both;">
        <span class="left" id="msgmemb1" style="color:#F00;"></span>
        <span class="right" id="msgmemage1" style="color:#F00;"></span>
        </p>
        <br />
        <p>
            <select class="lang_drp left" name="gender[]">
