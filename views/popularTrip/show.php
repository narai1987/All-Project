...
<script type="text/javascript">
	...
	function paging(page) {
		...
		$.ajax({
			url:"ajax.php?control=popularTrip&task=ajaxShow&country1="+country1+"&origin="+origin+"&destination="+destination+"&start_date="+start_date+"&end_date="+end_date+"&page="+page,
			 success:function(rp){
				 //alert(rp);
				$("#LajaxData").html(rp);
	...
	function paging2(page) {
		...
		document.getElementById("ajax_loader").style.display="block";
		$.ajax({
			url:"ajax.php?control=popularTrip&task=ajaxDayShow&country1="+country1+"&origin="+origin+"&destination="+destination+"&start_date="+start_date+"&end_date="+end_date+"&page2="+page,
...
<div id="main_box_cont">
  <div class="main_box">
    <p class="content_heading">Popular Trips</p>
