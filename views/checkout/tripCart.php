...
function goToStepThree(){
		...
		( $('#addCart').stop(true, true).fadeOut( 600 ), $('#stpfourli').removeClass( 'st-open' ).stop().animate({
			height	: $('#stpfourli').data( 'originalHeight' )
		}, 600, 'easeInOutExpo' ) )
...
<div class="st-content" id="addCart">
...
<!--PAY PAL CODE START HERE-->
   ...
   <!-- <input type="hidden" name="cancel_return" value="http://infranix.net/idive/mobile.php?control=api&task=paypalCancel&userId=<?php echo $userId ?>&tripId=<?php echo $tripId; ?>">
    ...
    <img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">-->
       ...
       <button type="button" onclick="goBack()" class="lang_button"><strong>Back</strong></button>&nbsp;&nbsp;&nbsp;<button disabled="disabled" class="lang_button"><strong>Proceed to Checkout</strong></button></td>
</tr>
