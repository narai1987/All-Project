      ...
      <div class="grid_container">
        <div class="main_collaps">
          <form name="formBoat" action="index.php" method="post" enctype="multipart/form-data"  onsubmit="return boatValidate();"><!---->
            ...
            <div class='tab-container'>
                <ul class='etabs'>
                  <li class='tab'><a href="#lang0_11">Boat Facilities</a></li>
                  <li class='tab'><a href="#lang0_12">Boat Safety</a></li>
                  <li class='tab'><a href="#lang0_13">Communication & Navigation</a></li>
                  <li class='tab'><a href="#lang0_14">Diving Options</a></li>
                  <li class='tab'><a href="#lang0_15">Power Options</a></li>
                </ul>
                <div class='panel-container'>
                  <div id="lang0_11" class="pans">
                    <table width="97%" cellpadding="0" cellspacing="4" class="add_language" >
                       ...
                       <tr>
               <?php $g = 1; foreach($Facilities as $Facility):  ?>
                <td align="right" width="20%" style="text-align:left;">
                <input type="checkbox"  class="" id="" value="<?php echo $Facility['id']; ?>" name="Facility[]" <?php if(strpos($results['common'][0]->boat_facilities,$Facility['id']) !== false){ ?> checked="checked" <?php } ?>/> <?php echo $Facility['title']; ?> 
                        </td>
                <?php if($g % 2 == 0){  ?>
              			</tr><tr>
                <?php  } $g++;endforeach; ?>
                  ...
                  <div id="lang0_12" class="pans">
                    <table width="97%" cellpadding="0" cellspacing="4" class="add_language">
                       <tr>
               <?php $g = 1;foreach($safetyFeatures as $safetyFeature):  ?>
                <td align="right" width="20%" style="text-align:left;">
                <input type="checkbox" class="" id="" value="<?php echo $safetyFeature['id']; ?>" name="safety[]" <?php if(strpos($results['common'][0]->boat_safety,$safetyFeature['id']) !== false){ ?> checked="checked" <?php } ?>/> <?php echo $safetyFeature['title']; ?> 
                        </td>
                <?php if($g % 2 == 0){  ?>
              			</tr><tr>
                <?php  } $g++;endforeach; ?>
                  ...
                  <div id="lang0_13" class="pans">
                    <table width="97%" cellpadding="0" cellspacing="4" class="add_language">
                       <tr>
               <?php $g = 1;foreach($communications as $communication):  ?>
                <td align="right" width="20%" style="text-align:left;">
                <input type="checkbox" class="" id="" value="<?php echo $communication['id']; ?>" name="communication[]" <?php if(strpos($results['common'][0]->boat_comunication_and_navigation,$communication['id']) !== false){ ?> checked="checked" <?php } ?>/> <?php echo $communication['title']; ?> 
                        </td>
                <?php if($g % 2 == 0){  ?>
              			</tr><tr>
                <?php  } $g++;endforeach; ?>
                  ...
                  <div id="lang0_14" class="pans">
                    <table width="97%" cellpadding="7" cellspacing="8" class="add_language" >
                       <tr>
                        <td align="right" width="20%"><strong><em class="star_red">*</em> Tec Dive Friendly :</strong></td>
                        <td width="29%">
                        <input type="checkbox" class="lang_box" name="tec_dive_friendly" id="tec_dive_friendly" value="1" <?php if($powerAndDivingFeatures[0]['tec_dive_friendly']){ ?> checked="checked" <?php } ?>/>
                        </td>
                        
                        <td align="right" width="20%"><strong><em class="star_red">*</em> CCR friendly :</strong></td>
                        <td>
                        <input type="checkbox" class="lang_box" name="ccr_friendly" id="ccr_friendly" value="1"  <?php if($powerAndDivingFeatures[0]['ccr_friendly']){ ?> checked="checked" <?php } ?>/>
                        </td>
                      </tr>
                      
                      <tr>
                        <td align="right" width="22%"><strong><em class="star_red">*</em> Dive Course friendly :</strong></td>
                        <td width="29%">
                        <input type="checkbox" class="lang_box" name="dive_course_friendly" id="dive_course_friendly" value="1"  <?php if($powerAndDivingFeatures[0]['dive_course_friendly']){ ?> checked="checked" <?php } ?>/>
                        </td>
                        
                        <td align="right" width="20%"><strong><em class="star_red">*</em> Dive platform :</strong></td>
                        <td>
                        <input type="checkbox" class="lang_box" name="dive_platform" id="dive_platform" value="1"  <?php if($powerAndDivingFeatures[0]['dive_platform']){ ?> checked="checked" <?php } ?>/>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td align="right" width="20%"><strong><em class="star_red">*</em> Nitrox :</strong></td>
                        <td width="29%">
                        <input type="checkbox" class="lang_box" name="nitrox" id="nitrox" value="1"  <?php if($powerAndDivingFeatures[0]['nitrox']){ ?> checked="checked" <?php } ?>/>
                        </td>
                        
                        <td align="right" width="20%"><strong><em class="star_red">*</em> Trimix :</strong></td>
                        <td>
                        <input type="checkbox" class="lang_box" name="trimix" id="trimix" value="1" <?php if($powerAndDivingFeatures[0]['trimix']){ ?> checked="checked" <?php } ?> />
                        </td>
                      </tr>
                      
                      
                       <tr>
                          <td align="right" width="20%"><strong><em class="star_red">*</em> Compresor Type 1:</strong></td>
                          <td width="29%"><input type="text" class="lang_box" name="compresor_type1" id="compresor_type1" value="<?php echo $powerAndDivingFeatures[0]['compresor_type1'];?>"/>
                          <span id="msgcompresor_type1" style="color:red;" class="font"></span>
                          
                          </td>
                          <td align="right" width="20%"><strong><em class="star_red">*</em> No. of Compressor:</strong></td>
                          <td><input type="text" class="lang_box" name="no_of_compresor1" id="no_of_compresor1" value="<?php echo $powerAndDivingFeatures[0]['no_of_compresor1'];?>" onkeyup="chkNumeric(this.value,this.id)"/>
                          
                          <span id="msgno_of_compresor1" style="color:red;" class="font"></span>
                      ...
                      <tr>
                        <td align="right" width="20%"><strong><em class="star_red"></em> Compresor Type 2:</strong></td>
                        <td width="29%"><input type="text" class="lang_box" name="compresor_type2" id="compresor_type2" value="<?php echo $powerAndDivingFeatures[0]['compresor_type2']; ?>"/>
                         </td>
                        <td align="right" width="20%"><strong><em class="star_red"></em> No. of Compressor :</strong></td>
                        <td><input type="text" class="lang_box" name="no_of_compresor2" id="no_of_compresor2" value="<?php echo $powerAndDivingFeatures[0]['no_of_compresor2']; ?>" onkeyup="chkNumeric(this.value,this.id)"/>
                        </td>
                      </tr>
                  ...
                  <div id="lang0_15" class="pans">
                    <table width="97%" cellpadding="0" cellspacing="4" class="add_language">
                      <tr>
                        <td align="right" width="20%"><strong><em class="star_red">*</em> Engine Type 1 :</strong></td>
                        <td width="29%"><input type="text" class="lang_box" name="engine_type1" id="engine_type1" value="<?php echo $powerAndDivingFeatures[0]['engine_type1']; ?>" />
                          <span id="msgengine_type1" style="color:red;" class="font"></span></td>
                        <td align="right" width="20%"><strong><em class="star_red">*</em> No. of Engine :</strong></td>
                        <td><input type="text" class="lang_box" name="no_of_engine1" id="no_of_engine1" value="<?php echo $powerAndDivingFeatures[0]['no_of_engine1']; ?>" onkeyup="chkNumeric(this.value,this.id)"/>
                          <span id="msgno_of_engine1" style="color:red;" class="font"></span></td>
                      </tr>
                      <tr>
                        <td align="right" width="20%"><strong><em class="star_red">*</em> Engine Type 2:</strong></td>
                        <td width="29%"><input type="text" class="lang_box" name="engine_type2" id="engine_type2" value="<?php echo $powerAndDivingFeatures[0]['engine_type2']; ?>"/>
                         </td>
                        <td align="right" width="20%"><strong><em class="star_red">*</em> No. of Engine :</strong></td>
                        <td><input type="text" class="lang_box" name="no_of_engine2" id="no_of_engine2" value="<?php echo $powerAndDivingFeatures[0]['no_of_engine2']; ?>"  onkeyup="chkNumeric(this.value,this.id)"/></td>
                      </tr>
                      
                      
                       <tr>
                          <td align="right" width="20%"><strong><em class="star_red">*</em> Generator Type 1:</strong></td>
                          <td width="29%"><input type="text" class="lang_box" name="generator_type1" id="generator_type1" value="<?php echo $powerAndDivingFeatures[0]['generator_type1'];?>"/>
                          <span id="msggenerator_type1" style="color:red;" class="font"></span>
                          
                          </td>
                          <td align="right" width="20%"><strong><em class="star_red">*</em> No. of Generator:</strong></td>
                          <td><input type="text" class="lang_box" name="no_of_generator1" id="no_of_generator1" value="<?php echo $powerAndDivingFeatures[0]['no_of_generator1'];?>" onkeyup="chkNumeric(this.value,this.id)"/>
                          
                          <span id="msgno_of_generator1" style="color:red;" class="font"></span>
                      ...
                      <tr>
                        <td align="right" width="20%"><strong><em class="star_red">*</em> Generator Type 2:</strong></td>
                        <td width="29%"><input type="text" class="lang_box" name="generator_type2" id="generator_type2" value="<?php echo $powerAndDivingFeatures[0]['generator_type2']; ?>"/>
                          <span id="msggenerator_type2" style="color:red;" class="font"></span></td>
                        <td align="right" width="20%"><strong><em class="star_red"></em> No. of Generator :</strong></td>
                        <td><input type="text" class="lang_box" name="no_of_generator2" id="no_of_generator2" value="<?php echo $powerAndDivingFeatures[0]['no_of_generator2']; ?>" onkeyup="chkNumeric(this.value,this.id)"/>
                          <span id="msgno_of_generator2" style="color:red;" class="font"></span></td>
                      </tr>
...
{  
 ...
 /*  var beverageVal = 1;
  ...
  if(document.getElementById('cockpit_storage').value == '') { 
	...
	/*BOAT POWER AND DIVING FEATURES VALIDATION START*/
	
	
  if(document.getElementById('compresor_type1').value == '') { 
	document.getElementById('msgcompresor_type1').innerHTML ="*Required field.";
	chk=0;
	}else {
	document.getElementById('msgcompresor_type1').innerHTML = "";
	}
	
  if(document.getElementById('no_of_compresor1').value == '') { 
	document.getElementById('msgno_of_compresor1').innerHTML ="*Required field.";
	chk=0;
	}else {
	document.getElementById('msgno_of_compresor1').innerHTML = "";
	}
	
  if(document.getElementById('engine_type1').value == '') { 
	document.getElementById('msgengine_type1').innerHTML ="*Required field.";
	chk=0;
	}else {
	document.getElementById('msgengine_type1').innerHTML = "";
	}
	
  if(document.getElementById('no_of_engine1').value == '') { 
	document.getElementById('msgno_of_engine1').innerHTML ="*Required field.";
	chk=0;
	}else {
	document.getElementById('msgno_of_engine1').innerHTML = "";
	}
	
  if(document.getElementById('generator_type1').value == '') { 
	document.getElementById('msggenerator_type1').innerHTML ="*Required field.";
	chk=0;
	}else {
	document.getElementById('msggenerator_type1').innerHTML = "";
	}
	
  if(document.getElementById('no_of_generator1').value == '') { 
	document.getElementById('msgno_of_generator1').innerHTML ="*Required field.";
	chk=0;
	}else {
	document.getElementById('msgno_of_generator1').innerHTML = "";
	}
	/*BOAT POWER AND DIVING FEATURES VALIDATION START*/
