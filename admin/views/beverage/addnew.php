            ...
            <table width="99%">
              <tr>
                <td width="85%" class="main_txt"><?php echo $result['id']?$results['content'][$_SESSION['language_id']]['edit']:$results['content'][$_SESSION['language_id']]['add_new'];?> <?php echo $results['content'][$_SESSION['language_id']]['doctor'];?>
                  <?php if($results['content'][1]['id']=='') { echo "Add New Beverage"; } else {echo "Edit Beverage";} ?></td>
                <td></td>
              </tr>
            </table>
          </h2>
        ...
        <div class="grid_container">
          <div class="main_collaps">
            <div style="padding:10px;">
              <table >
                <tr>
                  <td><strong><em class="star_red">*</em>Beverage Types :</strong>
...
?>
              ...
              <div id="chlang<?php echo $language['id'];?>" style="border:1px solid #f0f5ff; border-top:none !important; margin-top:-3px;">
                <table width="99%" cellpadding="0" cellspacing="8" class="tab_regis _merg_top">
                  <tr>
                    <td width="20%" align="right"><strong><em class="star_red">*</em> Beverage :</strong></td>
                    <td><input type="text" name="beverage<?php echo $language['id'];?>" id="beverage<?php echo $language['id'];?>" value="<?php echo $results['content'][$language['id']]['beverage']; ?>" class="lang_box"  onkeyup="changelag(this.id,'<?php echo $language['id'];?>')" /><br />
                      <span id="msgbeverage<?php echo $language['id'];?>" style="color:red;" class="font"> </span></td>
                  </tr>
                  <tr valign="top">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="tab_button">
              <tr>
                ...
                <td align="center" ><button class="lang_button" type="submit"><strong>Submit</strong></button>
                  <button class="lang_button_re" type="reset"  onclick="resetBeverageValidate()"><strong>Reset</strong></button></td>
              </tr>
            </table><br />
...
function resetBeverageValidate()	
	{ 
	
	document.getElementById('msgbeverage_id').innerHTML = "";
	document.getElementById('msgbeverage1').innerHTML="";
