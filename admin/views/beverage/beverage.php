...
<table width="99%">
<tr>
<td width="60%" class="main_txt">Beverage Types<?php //echo $keyword['trips'];?></td> 
...
<td><a href="index.php?control=beverage&task=beverage_addnew" ><img src="images/add_new.png" /></a></td>
</tr>
</table>
</h2>
</div>
...
<td class="tr_haed" width="35%"><strong>Beverage Name</strong></td>
...
<td >
<?php echo $result['beverage_type']; ?></td> 
<td  align="center">
 <a onclick="beveragetype_edit(<?php echo $result['id']; ?>)" style="cursor:pointer;" title="Edit"><img src="images/edit.png" alt="edit" title="Edit" /></a>

<?php if($result['status']){  ?>

 <a onclick="beveragetype_status(<?php echo $result['id']; ?>,0)" style="cursor:pointer;" title="Click to Unpublish"><img src="images/backend/check.png" alt="check_de" /></a>  
<?php } else { ?>
 <a onclick="beveragetype_status(<?php echo $result['id']; ?>,1)" style="cursor:pointer;" title="Click to Publish"><img src="images/backend/check_de.png" alt="check_de" /></a>  
<?php } ?>

 <a onclick="beveragetype_delete(<?php echo $result['id']; ?>)" style="cursor:pointer;" title="Delete"><img src="images/backend/del.png" alt="Delete" title="Delete" /></a>
</td>
</tr>
