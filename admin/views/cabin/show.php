  ...
  <div class="detail_container">
    <div class="head_cont">
      <h2 class="main_head">
        <table width="99%">
          <tr>
            <td width="60%" class="main_txt">Cabins </td>
            <td align="center" >
            ...
            <td><a href="index.php?control=cabin&task=addnew" ><img src="images/add_new.png" /></a></td>
          </tr>
        </table>
      </h2>
    </div>
    <div class="grid_container" id="mmm">
      <table width="99%" cellpadding="0" cellspacing="0" class="grid">
        <tr>
          ...
          <td class="tr_haed" width="35%"><strong>Cabin Description</strong></td>
...
?>
        <tr class="<?php echo $class; ?>">
          ...
          <td ><?php echo $cabin['detail']; ?></td>
          <td  align="center">
               <a onclick="cabin_edit(<?php echo $cabin['id']; ?>)" style="cursor:pointer;" title="Edit"><img src="images/edit.png" alt="edit" title="Edit" /></a>
            <?php if($cabin['status']) {?>
          
             <a onclick="cabin_status(<?php echo $cabin['id']; ?>,0)" style="cursor:pointer;" title="Click to Unpublish">
            <img src="images/backend/check.png" title="Click to Unpublish"/> </a>
            <?php }else  {?>
           <a onclick="cabin_status(<?php echo $cabin['id']; ?>,1)" style="cursor:pointer;" title="Click to Publish"> 
           <img src="images/backend/check_de.png" title="Click to Publish"/> </a>
            <?php } ?>
          
                 <a onclick="cabin_delete(<?php echo $cabin['id']; ?>)" style="cursor:pointer;" title="Delete"> <img src="images/backend/del.png" alt="Delete" title="Delete" /></a></td>
        </tr>
        <?php } }else{ ?>
        <tr>
