  ...
  <div class="detail_container">
    <div class="head_cont">
      <h2 class="main_head">
        <table width="99%">
          <tr>
            <td width="60%" class="main_txt">Cabin Options </td>
            <td align="center" >
            <form name="filterForm"  id="filterForm" method="post" action="index.php" >
                ...
                <input type="hidden" name="defftask" id="defftask" value="showoption"   />
                <input type="hidden" name="del" id="del"  />
                <input type="hidden" name="edit" id="edit"  />
              </form></td>
            <td><a href="index.php?control=cabin&task=addnewoption" ><img src="images/add_new.png" /></a></td>
          </tr>
        </table>
      </h2>
    </div>
    <div class="grid_container" id="mmm">
      <table width="99%" cellpadding="0" cellspacing="0" class="grid">
        <tr>
          ...
          <td class="tr_haed" width="35%"><strong>Cabin Option</strong></td>
          <td class="tr_haed" width="35%"><strong>Cabin Name</strong></td>
...
?>
        <tr class="<?php echo $class; ?>">
          ...
          <td ><?php echo $cabin['option']; ?></td>
          <td ><?php echo $cabin['cabin']; ?></td>
          <td  align="center">
               <a onclick="cabin_optionedit(<?php echo $cabin['id']; ?>)" style="cursor:pointer;" title="Edit"><img src="images/edit.png" alt="edit" title="Edit" /></a>
            <?php if($cabin['status']) {?>
          
             <a onclick="cabin_optionstatus(<?php echo $cabin['id']; ?>,0)" style="cursor:pointer;" title="Click to Unpublish">
            <img src="images/backend/check.png" title="Click to Unpublish"/> </a>
            <?php }else  {?>
           <a onclick="cabin_optionstatus(<?php echo $cabin['id']; ?>,1)" style="cursor:pointer;" title="Click to Publish"> 
           <img src="images/backend/check_de.png" title="Click to Publish"/> </a>
            <?php } ?>
          
                 <a onclick="cabin_optiondelete(<?php echo $cabin['id']; ?>)" style="cursor:pointer;" title="Delete"> <img src="images/backend/del.png" alt="Delete" title="Delete" /></a></td>
        </tr>
        <?php } }else{ ?>
        <tr>
