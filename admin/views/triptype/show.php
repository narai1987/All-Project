  ...
  <div class="detail_container">
    <div class="head_cont">
      <h2 class="main_head">
        <table width="99%">
          <tr>
            <td width="60%" class="main_txt">Trip Types
            ...
            <!--<td><a href="index.php?control=triptype&task=addnew" ><img src="images/add_new.png" /></a></td>--> 
          </tr>
        </table>
      </h2>
    </div>
    <div class="grid_container" id="mmm">
      <table width="99%" cellpadding="0" cellspacing="0" class="grid">
        <tr>
          ...
          <td class="tr_haed" width="35%"><strong>Trip type</strong></td>
          <!--
...
?>
        <tr class="<?php echo $class ?>">
          ...
          <td  align="center"><!--<a href="index.php?control=triptype&task=addnew&id=<?php // echo $trip['id'] ; ?>" ><img src="images/edit.png" alt="edit" title="Edit" /></a> --><a  onclick="triptype_edit(<?php echo $trip['id']; ?>)" style="cursor:pointer;"><img src="images/edit.png" alt="edit" title="Edit" /></a> 
...
<?php } ?>--> 
            <!--<a href="index.php?control=triptype&task=delete&id=<?php echo $trip['id']; ?>" onclick="return confirm('Are you sure you want to Delete ')" ><img src="images/backend/del.png" alt="Delete" title="Delete" /></a>--></td>
        </tr>
        <?php } }else{ ?>
        <tr>
