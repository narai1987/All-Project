...
<form name="formBoat" action="index.php" method="post" enctype="multipart/form-data" onsubmit="return formValidate();" >
        ...
        <fieldset><legend><strong>Trips For</strong></legend>
          <div id="lang0_1" class="pans">
           <table width="97%" cellpadding="0" cellspacing="4" class="add_language"> 
                        ...
                        <td width="29%">
                        <select class="lang_box" name="country_id" id="country_id">
                        ...
                        <td width="29%">
                       <input class="lang_box" id="inputDate" value="<?php echo $results['common']->start_date?date("Y-m-d",strtotime($results['common']->start_date)):date("Y-m-d"); ?>" name="start_date"/></td>
                         <td align="right" width="20%"><strong><em class="star_red">*</em> End Date :</strong></td>
                        <td width="29%">
                        <input class="lang_box" id="inputDate2" value="<?php echo $results['common']->end_date?date("Y-m-d",strtotime($results['common']->end_date)):date("Y-m-d"); ?>" name="end_date"/>
                        </td>
                        </tr> 
                        <tr>
                        ...
                        <td>
                        <input type="text" class="lang_box" name="no_of_dives" id="no_of_dives" value="<?php echo $results['common']->no_of_dives; ?>"/>                        
                        </td>
                        ...
                        <td>
                        <input type="text" class="lang_box" name="no_of_nights" id="no_of_nights" value="<?php echo $results['common']->no_of_nights; ?>"/>                        
                        </td>
                        ...
                        <td>
                        <input type="file" class="lang_box" name="image" id="image"/>                        
                        </td>
                        <td align="right" width="20%"><strong><em class="star_red">*</em> Trip Gallery(multiple images) :</strong></td>
                        <td width="29%"><input type="file" class="lang_box" name="trip_gallery[]" id="trip_gallery[]" multiple/></td>
                       </tr>
	  ...
	  if(value == 'paid'){
          ...
          <div id="lang0_1" class="pans">
           <table width="97%" cellpadding="0" cellspacing="4" class="add_language">                        
                        ...
                        <td width="19%">
                        <select class="lang_box" name="company" id="company">
                        ...
                        <td width="21%">
                       <input class="lang_box" id="price_for_kids" value="<?php echo $results['common']->price_for_kids; ?>" name="price_for_kids"/>
                        </td>
