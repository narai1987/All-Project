  ...
  <div class="detail_container">
    <div class="head_cont">
      <h2 class="main_head">
        <table width="99%">
          <tr>
            <td width="60%" class="main_txt">Boat Cockpit features
            ...
            <td><a href="index.php?control=boatfeature&task=boat_cockpit_feature_addnew" ><img src="images/add_new.png" /></a></td>
          </tr>
        </table>
      </h2>
    </div>
...
?>
        <tr class="<?php echo $class ?>">
          ...
          <td  align="center">
           <a onclick="boat_cockpit_feature_edit(<?php echo $result['id']; ?>)" style="cursor:pointer;" title="Edit">
          <img src="images/edit.png" alt="edit" title="Edit" /></a>
            <?php if($result['status']){  ?>
           
             <a onclick="boat_cockpit_feature_status(<?php echo $result['id']; ?>,0)" style="cursor:pointer;" title="Click to Unpublish">
            <img src="images/backend/check.png" alt="check_de" /></a>
            <?php } else { ?>
           
             <a onclick="boat_cockpit_feature_status(<?php echo $result['id']; ?>,1)" style="cursor:pointer;" title="Click to Publish">
            <img src="images/backend/check_de.png" alt="check_de" /></a>
            <?php } ?>
             <a onclick="boat_cockpit_feature_delete(<?php echo $result['id']; ?>)" style="cursor:pointer;" title="Delete">
