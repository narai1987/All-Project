...
<div class="detail_right right">
  <form action="index.php" method="post" onsubmit="return boatfacility('<?php echo $results['language'][0]['id'];?>')" enctype="multipart/form-data">
            ...
            <table width="99%">
              <tr>
                <td width="85%" class="main_txt"><?php echo $result['id']?$results['content'][$_SESSION['language_id']]['edit']:$results['content'][$_SESSION['language_id']]['add_new'];?> <?php echo $results['content'][$_SESSION['language_id']]['doctor'];?>
                  <?php if($results['content'][1]['id']=='') { echo "Add New Boat Facility Features"; } else {echo "Edit Boat Facility Features";} ?></td>
                <td></td>
              </tr>
            </table>
          </h2>
...
?>
              ...
              <input type="hidden" name="task" value="boat_facility_save"/>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="tab_button">
              <tr>
                ...
                <td align="center" ><button class="lang_button" type="submit"><strong>Submit</strong></button>
                  <button class="lang_button_re" type="reset" onclick="resetfacility()"><strong>Reset</strong></button></td>
              </tr>
            </table><br />
