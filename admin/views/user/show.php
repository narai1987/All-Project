...
<div class="head_cont">
<h2 class="user_s">
<table width="99%"><tr><td width="60%">Users</td> 
...
<input type="checkbox" onclick="check_users(this)"  /></td>
<td class=" grd_sep tr_haed" width="25%"><strong>Name</strong></td>
<td class="grd_sep tr_haed " width="35%"><strong>Email</strong></td>
...
<input type="checkbox" name="select" id="select" value="<?php echo $result['id'] ; ?>"  /></td>
<td class="<?php echo $class; ?>"><?php echo $result['fname'] ; ?></td>
