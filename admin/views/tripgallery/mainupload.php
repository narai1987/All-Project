...
<div align="center">
    ...
    <form action="ajax.php?control=tripgallery" onSubmit="return false" method="post" enctype="multipart/form-data" id="MainUploadForm">
...
<h3>Update Image</h3>
    ...
    <input type="hidden" name="tripidd2" id="tripidd2" value="<?php echo $_REQUEST['gallery']; ?>"/>
