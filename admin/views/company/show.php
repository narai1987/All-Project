  ...
  <div class="detail_container">
    <div class="head_cont">
      <h2 class="main_head">
        <table width="99%">
          <tr>
            <td width="60%" class="main_txt">Companies </td>
            ...
            <td><a href="index.php?control=company&task=addnew" ><img src="images/add_new.png" /></a></td>
          </tr>
        </table>
      </h2>
    </div>
    <div class="grid_container" id="mmm">
      <table width="99%" cellpadding="0" cellspacing="0" class="grid">
        <tr>
          ...
          <td class="tr_haed bord_right " width="35%"><strong>Company Name</strong></td>
          <td class="tr_haed bord_right " width="35%"><strong>Company Logo</strong></td>
...
?>
        <tr class="<?php echo $class; ?>">
          ...
          <td ><img src="<?php echo $company['logo']; ?>" width="45" alt="edit" title="logo" /></td>
          <td  align="center">
               <a onclick="company_edit(<?php echo $company['id']; ?>)" style="cursor:pointer;" title="Edit">
          <img src="images/edit.png" alt="edit" title="Edit" /></a>
            <?php if($company['status']) {?>
         
             <a onclick="company_status(<?php echo $company['id']; ?>,0)" style="cursor:pointer;" title="Click to Unpublish">
             <img src="images/backend/check_de.png" title="Click to Unpublish"/> </a>
            <?php }else  {?>
            <a onclick="company_status(<?php echo $company['id']; ?>,1)" style="cursor:pointer;" title="Click to Publish"> <img src="images/backend/check.png" title="Click to Publish"/> </a>
            <?php } ?>
          
             <a onclick="company_delete(<?php echo $company['id']; ?>)" style="cursor:pointer;" title="Delete">
            <img src="images/backend/del.png" alt="Delete" title="Delete" /></a> <a class="button" onclick="iframeBranch('<?php echo $company['id']; ?>')"><img src="images/backend/branch_icon.png" alt="Branches" title="Branch" /></a></td>
          <!-- href="index.php?control=company&task=branch&cid=<?php echo $company['id']; ?>"--> 
        </tr>
        <?php } }else{ ?>
        <tr>
