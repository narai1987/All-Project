...
document.getElementById("s_label").innerHTML="Edit News"
document.getElementById('snameid').innerHTML = "";
document.getElementById('desid').innerHTML = "";
document.getElementById('spanid').innerHTML = "Update";	
}
...
document.getElementById("s_label").innerHTML="Add News"
document.getElementById('snameid').innerHTML = "";
document.getElementById('desid').innerHTML = "";
document.getElementById('spanid').innerHTML = "Save";		
}
...
<td width="18%"><input type="text" class="reg_txt" name="search" value="<?php echo $_REQUEST['search'] ;?>" /></td>
...
<div class="head_cont">
<h2 class="news_s">
<table width="99%"><tr><td width="45%">News</td> 
...
<td><a href="#" onclick="delete_news()"><img src="images/Delete_all.png" /></a></td>
</tr>
</table>
</h2>
</div>

<div class="grid_container" id="allnews">
<table width="99%" cellpadding="0" cellspacing="0" class="grid">
<tr>
<td class="grd_sep tr_haed bord_left" width="4%" align="center">
<input type="checkbox" name="select_all" id="select_all" onclick="checkall_news(this)"  title="Select all" /></td>
...
?>
<tr>
<td class="<?php echo $class; ?>" align="center"><input name="select" id="select" type="checkbox" value="<?php echo $result['id'] ; ?>" /></td>
...
<a href="index.php?control=new&task=status&id=<?php echo $result['id'] ; ?>&status=0"  title="Click to Unpublish"><img src="images/backend/check.png" alt="check_de" /></a>  
<?php }else{ ?>
<a href="index.php?control=new&task=status&id=<?php echo $result['id'] ; ?>&status=1" title="Click to Publish"><img src="images/backend/check_de.png" alt="check_de" /></a>  
<?php } ?>
...
<div class="service_head_p"><p id="s_label">Add News</p></div>
...
<button class="submit" type="submit"><strong id="spanid">Save</strong></button> 
